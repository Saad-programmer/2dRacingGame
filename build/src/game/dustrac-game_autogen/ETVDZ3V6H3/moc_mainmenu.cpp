...
#include "../../../../../src/game/menu/mainmenu.hpp"
...
void MainMenu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->exitGameRequested(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_q_method_type _q_method = &MainMenu::exitGameRequested; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *MainMenu::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "SurfaceMenu"))
        return static_cast< SurfaceMenu*>(this);
...
// SIGNAL 0
void MainMenu::exitGameRequested()
{

/****************************************************************************
** Meta object code from reading C++ file 'scene.hpp'
**
...
#error "The header file 'scene.hpp' doesn't include <QObject>."
...
Q_CONSTINIT const QMetaObject Scene::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN5SceneE_t,
        ...
        // method 'listenerLocationChanged'
...
void Scene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->listenerLocationChanged((*reinterpret_cast< std::add_pointer_t<float>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<float>>(_a[2]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (Scene::*)(float , float );
            if (_q_method_type _q_method = &Scene::listenerLocationChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Scene::listenerLocationChanged(float _t1, float _t2)
{
